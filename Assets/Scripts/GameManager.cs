...
public class GameManager : MonoBehaviour {
	...
	void Start () {
		IEnumerator game = Game ();
		IEnumerator pause = Pause ();
		...
		ProjectileDropBoxManager.current.SetGroupActive (false);
	...
	void UpdateProjectilebar(){
		...
		player2projectilebar.rectTransform.sizeDelta = new Vector2(player1movement.numprojectiles * 20f,30f);
